  ...
  return (
    <>
      <div id="editor-container" style={{display: !show ? "block" : "none", maxWidth: resize ? "800px" : ""}}>
        <div id="editor-title"><h2 id="editor-text"><i className="fa fa-free-code-camp" style={{ fontSize: "22px" }}></i> Editor</h2><i id="expand" className={`fa fa-expand ${icon ? 'fa fa-compress' : ''}`} onClick={changeSize} style={{ fontSize: "22px" }}></i></div> 
      ...
      <div id="preview-container" style={{ display: !toggle ? "block" : "none" }}>
        <div id="preview-title"><h2 id="preview-text"><i className="fa fa-free-code-camp" style={{ fontSize: "22px" }}></i> Previewer</h2><i id="expand2" className={`fa fa-expand ${icon2 ? 'fa fa-compress' : ''}`} onClick={changeSize2} style={{ fontSize: "22px" }}></i></div>
